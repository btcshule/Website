...
<body class="loading authentication-bg" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
  <div class="account-pages pt-2 pt-sm-5 pb-4 pb-sm-5">
    <div class="container">
      <center><h1>SANYA DAY TO DAY</h1></center>
      <div class="row justify-content-center">
        <div class="col-xxl-4 col-lg-5">
          <div class="card">
            <div class="card-header pt-12 pb-12 text-center">
              <img src="<?=base_url('upload/SANYA.png')?>"  style="width: 65%;height:100px;" alt="">
            </div>

            <div class="card-body p-4">

              <form method="POST" action="<?= base_url('Login/go_submit') ?>" id="loginForm">
                <center>
          ...
          <!-- end card -->
<!--   <div class="text-center row" style="color:blue"><img src="<?=base_url('uploads/kbs.png')?>"  style="width: 30%;height: 80px;" alt=""></div>
 -->          <!-- end row -->
