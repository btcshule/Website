...
WHERE
    ...
    $search = !empty($_POST['search']['value']) ? (" AND  (PRODUCT_DESC LIKE '%$var_search%' OR QUANTITE_PRODUIT LIKE '%$var_search%' OR PRIX_ACHAT_UNITAIRE LIKE '%$var_search%' OR PRIX_VENTE_UNITAIRE LIKE '%$var_search%' OR TOTAL_ACHAT LIKE '%$var_search%' OR NOM_FOURNISSEUR LIKE '%$var_search%' OR PRENOM_FOURNISSEUR LIKE '%$var_search%' OR LOC_FOURNISSEUR LIKE '%$var_search%' OR NOM_EMP LIKE '%$var_search%' OR PRENOM_EMP LIKE '%$var_search%' OR gros_entrees_stock.DATE_INSERTION LIKE '%$var_search%') ") : '';
