          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <div class="row mb-2">
                  <div class="col-sm-5">
                    <a href="<?=base_url('index.php/stock/Entrees_stock')?>" class="btn btn-primary mb-2"><i class="mdi mdi-plus-circle me-2"></i> Approvisionner</a>
                  </div>
                </div> 

                     <?=$this->session->flashdata('message')?>  
                  <?php echo $this->table->generate($AllEntries); ?>
