...
<script>
  ...
  $(document).ready(function() {
   ...
   table=$("#mytable").DataTable({
    ...
    "order":[],
    "ajax":{
      url:"<?php echo base_url('index.php/stock/Categorie/liste')?>",
      type:"POST"
    },
  ...
  function enr()
  {
    ...
    if (statut==true) {
      ...
      if (CATH_ID=="") 
      {
        ...
        url="<?php echo base_url('index.php/stock/Categorie/ajouter')?>";
      }
      else
      {
        url="<?php echo base_url('index.php/stock/Categorie/update')?>";
      }
  ...
  function edit_emp(id)
{
 ...
 $('#emp_form')[0].reset();
    $('#emp-modal').modal('show');
  $.ajax({
    url : "<?php echo site_url('index.php/stock/Categorie/getOne')?>/" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
  ...
  function supp_logic(id,is_actif)
  {
    ...
    if (is_actif==1) {message="Voulez-vous désactiver?"} else {message="Voulez-vous activer?"}
     if (confirm(message)) {
      $.ajax({
        url : "<?php echo base_url('index.php/stock/Categorie/del')?>/"+id+'/'+is_actif,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
