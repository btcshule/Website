...
class Histo_livre_banque extends CI_Controller
{
  ...
  function index()
  {
    $data['page_title']="Suivi Bancaire";
    ...
    <li class="breadcrumb-item active" aria-current="page">Livre Banque</li>
    </ol>
    </nav>';
    $this->load->view('Histo_livre_banque_view',$data);
  }
  ...
  function liste()
  {
    ...
    $query_principal="SELECT `ID_LIVRE_BANQUE`, `LIBELLE`, `CODE_IMPUTATION`, NOM_EMP, PRENOM_EMP, `DEBIT`, `CREDIT`,SOLDE, `DATE_ENTREE`, `DATE_ACTION`,data_livre_banque.STATUT FROM `data_livre_banque` JOIN employes ON employes.EMPLOYE_ID=data_livre_banque.RESP_CAISSE JOIN imputations ON imputations.ID_IMPUTATION=data_livre_banque.IMPUTATION WHERE 1";
