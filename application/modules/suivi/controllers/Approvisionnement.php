...
class Approvisionnement extends CI_Controller
{
  ...
  function ajouter()
  {
    ...
    // $data=array('DATE_ENTREE'=>trim($DATE_ENTREE),'LIBELLE'=>trim($LIBELLE),'IMPUTATION'=>trim($IMPUTATION),'DEBIT'=>trim($MONTANT),'STATUT'=>trim($STATUT),'RESP_CAISSE'=>trim($RESP_CAISSE),'EST_ENTREE'=>trim($EST_ENTREE));
