...
class Approvisionnement_sortie extends CI_Controller
{
  ...
  function index()
  {
    ...
    $this->load->view('Approvisionnement_sortie_view',$data);
  }
  ...
  function liste()
  {
    $var_search = !empty($_POST['search']['value']) ? $_POST['search']['value'] : null;
     ...
     $query_principal="SELECT `ID_LIVRE_APPRO`, `LIBELLE`,`CODE_IMPUTATION`,NOM_EMP,PRENOM_EMP, `CREDIT`, `DATE_ENTREE`, `EST_ENTREE`, data_livre_approvisionnement.STATUT, `DATE_ACTION`, `RESP_CAISSE` FROM `data_livre_approvisionnement` JOIN employes ON employes.EMPLOYE_ID=data_livre_approvisionnement.RESP_CAISSE JOIN imputations ON imputations.ID_IMPUTATION=data_livre_approvisionnement.IMPUTATION WHERE EST_ENTREE=0";
