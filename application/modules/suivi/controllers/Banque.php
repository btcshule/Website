...
class Banque extends CI_Controller
{
  ...
  function index()
  {
    $data['page_title']="Gestionnaire des Versements";
    ...
    $this->load->view('Banque_view',$data);
  }
  ...
  function liste()
  {
    ...
    $query_principal="SELECT `ID_LIVRE_BANQUE`, `LIBELLE`,`CODE_IMPUTATION`,NOM_EMP,PRENOM_EMP, `DEBIT`, `CREDIT`, `DATE_ENTREE`, `EST_ENTREE`, data_livre_banque.STATUT, `DATE_ACTION`, `RESP_CAISSE` FROM `data_livre_banque` JOIN employes ON employes.EMPLOYE_ID=data_livre_banque.RESP_CAISSE JOIN imputations ON imputations.ID_IMPUTATION=data_livre_banque.IMPUTATION WHERE EST_ENTREE=1";
