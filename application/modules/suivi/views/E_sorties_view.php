          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <!-- <center><h2>Montant rétiré</h2></center> -->
...
<script>
  ...
  $(document).ready(function() {
   ...
   table=$("#mytable").DataTable({
    ...
    "order":[],
    "ajax":{
      url:"<?php echo base_url('index.php/suivi/E_sorties/liste')?>",
      type:"POST"
    },
  ...
  function enr()
  {
    ...
    if (statut==true) {
      ...
      if (ID_LUMICASH=="") 
      {
        ...
        url="<?php echo base_url('index.php/suivi/E_sorties/ajouter')?>";
      }
      else
      {
        url="<?php echo base_url('index.php/suivi/E_sorties/update')?>";
      }
