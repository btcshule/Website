						...
						<div class="card">
							<div class="card-body">
								<!-- <div class="row mb-2">
									...
									<div class="col-md-4"><h6> CAISSE APPROVISIONNEMENT</h6></div>
								<?php
...
<div class="col-md-8">
    <h4>Mois de : <?= strftime('%B %Y', $date->getTimestamp()) ?></h4>
</div>								
								</div>
...
<script>
	...
	$(document).ready(function() {
		...
		table=$("#mytable").DataTable({
			...
			"order":[],
			"ajax":{
				url:"<?php echo base_url('index.php/suivi/Histo_appro/liste')?>",
				type:"POST"
			},
...
<script>
	...
	function supp_logic(id, is_actif) {
		...
		if (confirm(message)) {
			$.ajax({
				url: "<?php echo base_url('index.php/suivi/Histo_appro/del')?>/" + id + '/' + is_actif,
				type: "POST",
				dataType: "JSON",
