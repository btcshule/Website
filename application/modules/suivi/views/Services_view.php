          ...
          <div class="card">
            <div class="card-body">
                  ...
                  <div class="form-group">
                    <div class="mb-3">
                      ...
                      foreach($users as $pro)
                      {
                        ...
                        {
                          ?>
                          <option value="<?= $pro['EMPLOYE_ID'] ?>"><?=$pro['PRENOM_EMP'].' '.$pro['NOM_EMP'] ?></option>
                          <?php
                        }
                      }
                      ?>
             ...
             <div class="col-md-6">
                <div class="form-group">
                  <div class="mb-3">
                    <label for="PRODUCT_ID" style="font-weight: 900; color:#ffffff">Consommables<span style ="color: red;">*</span></label>
                    <input type="text" autocomplete="off" class="form-control" name="PRODUCT_ID" id="PRODUCT_ID" placeholder="" required>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="mb-3">
                    ...
                    <input type="number" autocomplete="off" class="form-control" name="PC" id="PC" placeholder="" required max="">
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <div class="mb-3">
                    ...
                    <input type="number" autocomplete="off" class="form-control" name="MO" id="MO" placeholder="" required max="">
                  </div>
                </div>
              </div>              
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="mb-3">
                    ...
                    <input type="mumber" autocomplete="off" class="form-control" name="AF" id="AF" placeholder="" required="completez">
                  </div>
                </div>
              </div>
               <div class="col-md-6">
                  <div class="form-group">
                    <div class="mb-3">
                      <label style="font-weight: 900; color:#ffffff">Nature des frais<span style ="color: red;">*</span></label>
                      <input type="text" autocomplete="off" class="form-control" name="NAF" id="NAF" placeholder="" required="completez">
                    </div>
                  </div>
                </div>
                 <!--  <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <div class="mb-3">
                      <label style="font-weight: 900; color:#ffffff">Marge Commerciale<span style ="color: red;">*</span></label>
                      <input type="number" autocomplete="off" class="form-control" name="VA" id="VA" placeholder="" required="completez">
                    </div>
                  </div>
                </div>
                  <!-- <div class="col-md-6">
