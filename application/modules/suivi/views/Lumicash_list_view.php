...
<script>
  ...
  $(document).ready(function() {
   ...
   table=$("#mytable").DataTable({
    ...
    "order":[],
    "ajax":{
      url:"<?php echo base_url('index.php/suivi/Lumicash/liste')?>",
      type:"POST"
    },
  ...
  function enr()
  {
    ...
    if (statut==true) {
      ...
      if (ID_LUMICASH=="") 
      {
        ...
        url="<?php echo base_url('index.php/suivi/Lumicash/ajouter')?>";
      }
      else
      {
        url="<?php echo base_url('index.php/suivi/Lumicash/update')?>";
      }
  ...
  function edit_emp(id)
{
 ...
 $('#emp_form')[0].reset();
    $('#emp-modal').modal('show');
  $.ajax({
    url : "<?php echo site_url('suivi/Lumicash/getOne')?>/" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
  ...
  function supp_logic(id,is_actif)
  {
    ...
    if (is_actif==1) {message="Voulez-vous désactiver?"} else {message="Voulez-vous activer?"}
     if (confirm(message)) {
      $.ajax({
        url : "<?php echo base_url('donnees/Lumicash/del')?>/"+id+'/'+is_actif,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
              ...
              <div class="form-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="mb-3">
                        <label class="form-label">IMPUTATION<span style="color: red;">*</span></label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="mb-3">
                        <label class="form-label">Cash<span style="color: red;">*</span></label>
                        <input type="text" autocomplete="on" name="CASH" class="form-control" id="CASH" autofocus>
                    ...
                    <div class="form-group">
                      <div class="mb-3">
                        <label class="form-label">Electronique<span style="color: red;">*</span></label>
                        <input type="text" autocomplete="off" name="ELECTRONIQUE" class="form-control" id="ELECTRONIQUE" required>
