						...
						<div class="card">
							<div class="card-body">
								...
								<div class="col-md-12 row">
									<div class="col-md-4"><h3>LIVRE DE CAISSE</h3></div>
								<?php
...
<div class="col-md-8">
    <h3>Mois de : <?= strftime('%B %Y', $date->getTimestamp()) ?></h3>
</div>								
								</div>
...
<script>
	...
	$(document).ready(function() {
		...
		table=$("#mytable").DataTable({
			...
			"order":[],
			"ajax":{
				url:"<?php echo base_url('index.php/suivi/Histo_livre_caisse/liste')?>",
				type:"POST"
			},
