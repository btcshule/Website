...
<script>
  ...
  $(document).ready(function() {
   ...
   table=$("#mytable").DataTable({
    ...
    "order":[],
    "ajax":{
      url:"<?php echo base_url('administration/Logos/liste')?>",
      type:"POST"
    },
...
<script>
  function enr()
  {
   ...
   var url;
    ...
    url="<?php echo base_url('administration/Logos/update')?>";
...
function edit_logo(id)
{
  ...
  $('#log_form')[0].reset();
  $.ajax({
    url : "<?php echo site_url('administration/Logos/getOne')?>/" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {

      $('[name="LOGO_ID"]').val(data.LOGO_ID);
      $('[name="LIBELLE"]').val(data.LIBELLE);
      $('input[type=file]')[0].files[0];
      $('#logo-modal').modal('show');  
      $('#btnSave').text('Appliquer');
      $('.modal-title').text('Modifier un logo'); 
      document.getElementById('PHOTO').value=data.LOGO_DESC;
      var url_p="<?php echo base_url('uploads/logo/')?>";
      $('#LOGO_LOGO').html('<img src='+url_p+data.LOGO_DESC+' width="270px" width="250">');
...
<div id="logo-modal" class="modal fade" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="info-header-modalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="mb-3">
                        ...
                        <input type="text" readonly="" id="LIBELLE" class="form-control" name="LIBELLE">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="mb-3">
                        ...
                        <input type="file" name="LOGO_DESC" id="LOGO_DESC" class="form-control">
                        <span class="help-block"></span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      <div class="mb-3">
                        ...
                        <input type="hidden" name="PHOTO" id="PHOTO">
                         <div class="form-group" id="LOGO_LOGO"></div>
                      </div>
                    </div>
                  </div>
                  </div>
        ...
        <div class="modal-footer">
          <button type="button" id="btnSave" onclick="enr()" class="btn btn-info">Appliquer</button>
        </div>
      </div>
    </div>
  </div>
