                ...
                <table id="mytable" class="table table-striped dt-responsive nowrap w-100 table-responsive">
                  <thead>
                    <tr>
                      ...
                      <th>Poste de profil</th>
                      <th>Cahier de charges</th>
...
<script>
  function new_record(){
    ...
    $('.modal-title').text('Cahier des charges utilisateurs');
  }
</script>
...
<script>
  ...
  $(document).ready(function() {
   ...
   table=$("#mytable").DataTable({
    ...
    "order":[],
    "ajax":{
      url:"<?php echo base_url('index.php/administration/Users_profil/liste')?>",
      type:"POST"
    },
...
<script>
  function enr() {
    ...
    var USERPROFIL = $('#USERPROFIL').val();

    var statut = true;

    if (CHARGES == "") {
      $("#errCHARGES").html("Le champ est obligatoire");
      statut = false;
    } else {
      $("#errCHARGES").html("");
    }
    ...
    if (USERPROFIL == "") {
      $("#errUSERPROFIL").html("Le champ est obligatoire");
      statut = false;
    } else {
      $("#errUSERPROFIL").html("");
    }
    ...
    if (ID_USER_PROFIL == "") {
      url = "<?php echo base_url('index.php/administration/Users_profil/ajouter')?>";
    } else {
      url = "<?php echo base_url('index.php/administration/Users_profil/update')?>";
    }
  ...
  function edit_emp(id)
  {
    ...
    $.ajax({
      ...
      success: function(data)
      {
// SELECT `ID_USER_PROFIL`, `NOM_EMP`, `PRENOM_EMP`, `EMAIL_EMP`, `TEL_EMP`, `PROFILE_ID`, `IS_USER_SYSTEM`, `MOT_DE_PASSE`, `USER_ID`, `DATE_CREATION`, `IS_ACTIF`, `IS_MUST_CHANGE_PWD`, `ID_BRANCHE` FROM `employes` WHERE 1
        ...
        <div class="row">
          <div class="col-12">
            <form id="emp_form" method="POST">
              <div class="form-body">
                <input type="hidden" name="ID_USER_PROFIL" id="ID_USER_PROFIL">
                <div class="row">                  

                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="mb-3">
                       <label>Poste de profil</label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <div class="mb-3">
                    <label class="form-label">Point de service <span style="color: red;">*</span></label>
                    <input type="text" autocomplete="off" name="USERPROFIL" class="form-control" id="USERPROFIL" autofocus>
                    <span class="text-danger" id="errUSERPROFIL"></span>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <div class="mb-3">
                    <label class="form-label">Cahier de charges<span style="color: red;">*</span></label>
                    <textarea autocomplete="off" name="CHARGES" class="form-control" id="CHARGES" autofocus rows="4"></textarea>
