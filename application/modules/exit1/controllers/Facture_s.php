...
function listing()
{
    ...
    $search = !empty($_POST['search']['value']) ? (" AND  (NOM_GROS_CLIENT LIKE '%$var_search%'  OR date_format(mag_client_factur.DATE_ACTION,'%d-%m-%Y') LIKE '%$var_search%' OR RS LIKE '%$var_search%' OR AMOUNT_DETTE LIKE '%$var_search%' OR NUM_FACTURE LIKE '%$var_search%') ") : '';
    $critaire = "";
