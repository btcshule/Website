...
class Magasin_sales extends CI_Controller
{
  ...
  function index()
  {
    ...
    <li class="breadcrumb-item active" aria-current="page">Espace vente</li>
    </ol>
    </nav>';
    ...
    $data['CLIENT'] = $this->Model->getRequete("SELECT GROS_CLIENT_ID,RS,NIF,ADRESS_GROS_CLIENT,IS_CLIENT,ID_BRANCHE,NOM_GROS_CLIENT,PRENOM_GROS_CLIENT,TEL_GROS_CLIENT FROM `gros_client` WHERE IS_CLIENT=1 AND ID_BRANCHE=".$this->session->userdata('ID_BRANCHE')) ;
    $this->cart->destroy();
