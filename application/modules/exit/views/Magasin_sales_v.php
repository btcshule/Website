            ...
            <div class="card">
              <div class="card-body">
                 <h4>INFORMATIONS DU CLIENT</h4> 
                  <div class="row border p-2" style="background-color: #FF8D33" >
                  <div class="row">
                    <tr >
                  ...
                  <div class="col-md-12">
                   ...
                   <div class="form-group col-lg-2" style="padding-top:20px">
                    <a id="cartinfo" onclick="info_cart();" class=" btn btn-secondary"><span class="mdi mdi-plus-circle me-2">Ajouter au panier</span></a>
                  </div>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
  ...
  function get_data()
  {
    ...
    $.ajax(
    {                            
      url:"<?=base_url()?>index.php/exit/Magasin_sales/get_data_secre/"+DESIGNATION+'/'+type_produit,
      type:"GET",
      dataType:"JSON",
      success: function(data)
      {
...
<script>
  function info_cart() {
    ...
    if (GROS_CLIENT_ID=="") {
     alert_toast_validation('Echec','Merci de préciser le client','error');
    }else{
    if (UNITE_MESURE!=0) {
      if (QUANTITE1 < QUANTITEUN1 || QUANTITEUN1==0) {
        ...
        if (QUANTITEUN != "" &&  DESIGNATION != "" && PRIX_UNITAIRE != "") {
          $.post("<?=base_url('index.php/exit/Magasin_sales/add_in_cart/')?>", {
            ...
            if (response) {
              alert_toast_validation('success','Produit bien ajouté au panier','success');
