              ...
              <div class="card-body">
                <div class="row g-2">
                  <div class="mb-3 col-md-6">
                    <label for="inputDate1" class="form-label">FROM</label>
                    <input type="date" onchange="liste()" class="form-control" max="<?=date('Y-m-d')?>"  id="datedu"  name="datedu">
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="inputDate2" class="form-label">TO</label>
                    <input type="date" class="form-control" onchange="liste()" max="<?=date('Y-m-d')?>"id="dateau"  name="dateau">
                  </div>
                </div>
          ...
          <script>
           ...
           function liste()
           {
            ...
            table=$("#mytable").DataTable({
              ...
              "order":[],
              "ajax":{
                url:"<?php echo base_url('index.php/exit/Factures_and_sales/listing/')?>"+datedu+'/'+dateau,
                type:"POST"
              },
        ...
        <script>
          ...
          function enr()
          {
            ...
            if (stat==true) {
              ...
              var url;
              url="<?php echo base_url('index.php/exit/Factures_and_sales/update')?>";
              ...
              $.ajax({
                ...
                success: function(data)
                {
                 if(data.status) 
                 {
                  ...
                  alert_toast_validation('Réussie','Operation effectuée avec sussess','success');
                }
                else
                {
