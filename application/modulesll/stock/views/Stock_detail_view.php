                ...
                <div id="mytable-container" style="border: 5px solid gray; padding: 10px;">
                 <center>
                  <h1 style="display: inline-block;">
                    Inventaire du stock: <span id="montant" style="color: green; padding: 10px;"><?= number_format($somme['montant'], 0, ',', ' ') ?> BIF</span>
                  </h1>
                  <a href="<?= base_url('index.php/stock/Entrees_stock') ?>" class="btn btn-primary" style="display: inline-block; vertical-align: middle; margin-left: 10px;">Approvisionner</a>
                </center>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table=$("#mytable").DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?php echo base_url('index.php/stock/Stock_detail/liste')?>",
        type:"POST"
      },
