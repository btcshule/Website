          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <form method="POST" action="<?=base_url()?>stock/Produit/ajouter" id="fromm">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <div class="mb-3">
                    <label style="font-weight: 900; color:#454545">Nom article<span style ="color: red;">*</span></label>
                    <input type="text" autocomplete="off" class="form-control" name="DESIGNATION" id="DESIGNATION" placeholder="" required max="6"  value="<?=set_value('DESIGNATION');?>">
                  </div>
                </div>
              </div>
...
<script>
  ...
  function edit_emp(id)
  {
    ...
    $('#emp-modal').modal('show');
    $.ajax({
      url : "<?php echo site_url('index.php/donnees/Clients/getOne')?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data)
      {
        $('[name="LOCALISATION"]').val(data.LOC_CLIENT);
...
<script> 
 ...
 $("#quante_new,#STOCK_MUNI,#prix_achatUnit,#prix_vente,#prix_venteGROS").on('input paste change keyup', function()      
 {
...
<script>
    function getdesignations() {
      ...
      // alert(ministere);
      $.post('<?=base_url()?>stock/Entrees_stock/get_designations', {
    ...
    function get_data()
    {
      ...
      $.ajax(
      {
        url:"<?=base_url()?>index.php/stock/Entrees_stock/get_data/"+DESIGNATION,
        type:"GET",
        dataType:"JSON",
        success: function(data)
        {
