          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <form method="POST" action="<?=base_url()?>index.php/stock/Articles/ajouter" id="fromm">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="mb-3">
                      ...
                      <input type="text" autocomplete="off" class="form-control" name="DESIGNATION" id="DESIGNATION" placeholder="" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="mb-3">
                        <label style="font-weight: 900; color:#454545">Pièce par paquet<span style ="color: red;">*</span></label>
                        <input type="number" autocomplete="off" class="form-control" name="NOMBRE_PIECE" id="NOMBRE_PIECE" placeholder="">
                      </div>
                    </div>
                  </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table=$("#mytable").DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?php echo base_url('index.php/stock/Articles/liste')?>",
        type:"POST"
      },
