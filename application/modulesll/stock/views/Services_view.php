          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <form method="POST" action="<?=base_url()?>index.php/stock/Services/ajouter" id="fromm">
                 <div class="col-md-12 row">
                  <div class="col-md-3">
                    <div class="form-group">
                      <div class="mb-3">
                        <!-- <label>Catégories</label> -->
                       <label style="font-weight: 900; color:#454545">Catégories<span style ="color: red;">*</span></label>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="mb-3">
                      <label style="font-weight: 900; color:#454545">Service<span style ="color: red;">*</span></label>
                      <input type="text" autocomplete="off" class="form-control" name="LIBELLE" id="LIBELLE" placeholder="" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="mb-3">
                      <label style="font-weight: 900; color:#454545">Code<span style ="color: red;">*</span></label>
                      <input type="text" autocomplete="off" class="form-control" name="CODE" id="CODE" placeholder="" required>
                    </div>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <div class="mb-3">
                      <label style="font-weight: 900; color:#454545">Prix<span style ="color: red;">*</span></label>
                      <input type="text" autocomplete="off" class="form-control" name="PRIX" id="PRIX" placeholder="" required>
                    </div>
                  </div>
                </div>
                 <button type="submit" style="float: right;background-color:blue;color:white;border-radius:15px" class="btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>Sauvegarder</button>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table=$("#mytable").DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?php echo base_url('index.php/stock/Services/liste')?>",
        type:"POST"
      },
