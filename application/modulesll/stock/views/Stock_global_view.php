      ...
      <div class="content">
        ...
        <div class="row">
          ...
          <div id="mytable-container" style="border: 5px solid green; padding: 10px;">
            <center>
              <h1>
                Inventaire du stock: <span id="montant" style=" color: green; padding: 10px; display: inline-block;"><?= number_format($somme['montant'], 0, ',', ' ') ?> BIF</span>
              </h1>
            </center>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table=$("#mytable").DataTable({
      ...
      "order":[],
      "ajax":{
        url:"<?php echo base_url('index.php/stock/Stock_global/liste')?>",
        type:"POST"
      },
