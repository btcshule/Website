                ...
                <div class="row border p-2" >
                  <div class="row">
                    <tr >
                      ...
                      <div class="col-md-3">
                        <label><b>&nbsp&nbspClient</b></label>
                      ...
                      <div class="col-md-3">
                        <label><b>&nbsp&nbspAdresse</b></label>
                        <input  type="text" name="ADRESS" id="ADRESS" readonly class="form-control" value=""></div>
                        <div class="col-md-3">
                          <label><b>&nbsp&nbspContacts</b></label>
                          <input  type="text" name="TEL" id="TEL" readonly value="" class="form-control">
                        </div>
                        <div class="col-md-3">
                          <label><b>&nbsp&nbspServer</b></label>
                          <input  type="text" class="form-control" readonly value="<?=$this->session->userdata('FIRST_NAME')?> <?=$this->session->userdata('LAST_NAME')?>"><br></div>
                        </tr>
                      </div>
                    </div>
                  </form>
                  ...
                  <div class="col-md-12">
                   ...
                   <div class="form-group col-lg-2" style="padding-top:20px">
                    <a id="cartinfo" onclick="info_cart();" class=" btn btn-primary"><span class="mdi mdi-plus-circle me-2">Add  to cart</span></a>
                  </div>
...
<script>
  function info_cart() {
    ...
    if (GROS_CLIENT_ID=="") {
     alert_toast_validation('Echec','Oops!Choisissez le client','error');
    }else{
    if (UNITE_MESURE!=0) {
...
<script type="text/javascript">
 ...
 if (statut==1) {
  ...
  $.post("<?=base_url('index.php/exit/Magasin_sales/save_sale_manager/')?>", 
  {
   ...
   window.location.href='<?=base_url('')?>index.php/exit/Pending';
 }) 
}
}
