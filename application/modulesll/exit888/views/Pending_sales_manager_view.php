...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h5 class="m-0">Pending invoices</h5>
        </div><!-- /.col -->
        <div class="col-sm-6">
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <i>We have <?=$nb['nombre']?> pending invoices.You can accept or refuse invoice.</i>
        </div>
        <?php } ?>
        <?php if ($nb['nombre']==0) {?>
        ...
        <i>Our system has any pending invoice...</i>
        </div>
        <?php } ?>
              <br>
...
<script>
  ...
  $(document).ready(function() {
    ...
    table = $("#mytable").DataTable({
      ...
      "ajax": {
        url: "<?= base_url() ?>index.php/exit/Magasin_sales/liste_pending",
        type: "POST"
      },
      lengthMenu: [
