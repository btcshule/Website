            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input type="date" onchange="liste()" class="form-control"  id="datedu"  name="datedu">
                </div>
                <div class="mb-3 col-md-6">
                  <label for="inputDate2" class="form-label">TO</label>
                  <input type="date" class="form-control" onchange="liste()"  id="dateau"  name="dateau">
                </div>
              </div>
          ...
          <script>
            ...
            $(document).ready(function() {
             ...
             table=$("#mytable").DataTable({
              ...
              "order":[],
              "ajax":{
                url:"<?php echo base_url('exit/Factures_and_sales/listing')?>",
                type:"POST"
              },
