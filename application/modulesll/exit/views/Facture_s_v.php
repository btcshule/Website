          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box">
                ...
                <h4 class="page-title"><?=$title?>(<span class="text-danger"><b><?=number_format($tot['PT'], 2, '.', ',')?></b></span>BIF)</h4>
              </div>
            </div>
          </div>  
        </div>
          ...
          <script>
            ...
            $(document).ready(function() {
             ...
             table=$("#mytable").DataTable({
              ...
              "order":[],
              "ajax":{
                url:"<?php echo base_url('exit/Pending_s/listing')?>",
                type:"POST"
              },
...
<script type="text/javascript">
  function get_report_inventaire11(conn) {
    ...
    var url = '<?= base_url("index.php/rapport/Fact_services/index/") ?>'+conn;
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="mb-3">
                                ...
                                <label class="form-label"> Valider ou Annuler?<span style="color:red;">*</span></label>
                                <select class="form-control" name="STATUT_ID" id="STATUT_ID">
                                  <option value="">--Choisir l'action--</option>
                                  <option value="1"> Valider</option>
                                  <option value="22">Annuler</option>
                                </select>
