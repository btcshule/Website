...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h5 class="m-0">Add client and create new invoice</h5>
        </div><!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card">
           <div class="card-body" >
            <div style="padding-top: 5px;" class="col-md-12">
              ...
              <form method="post" action="<?=base_url()?>exit/Magasin_sales/register">
                <div class="col-md-12 row" id="conta" style="padding:5px">
...
<script>
  $(document).ready(function(){
    ...
    table=$("#mytable").DataTable({
      ...
      "oreder":[[ 0, 'desc' ]],
      "ajax":{
        url:"<?=base_url()?>exit/Magasin_sales/liste/",
        type:"POST"
      },
