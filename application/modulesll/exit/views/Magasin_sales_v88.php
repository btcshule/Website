                    ...
                    <tr >
                      ...
                      <div class="col-md-3">
                        ...
                        <select class="form-control select2" name="GROS_CLIENT_ID" id="GROS_CLIENT_ID" onchange="get_data_client()">
                          ...
                          <option value="clientpassager"><b>Client Inconnu</b></option>
                          <?php
                          foreach($CLIENT as $pro)
                          {
                            ?>
                            <option value="<?=$pro['GROS_CLIENT_ID'] ?>"><?=$pro['RS']."(".$pro['NIF'].")"?></option>
                            <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                          ...
                          <input  type="text" class="form-control" readonly value="SANYA SHOP" ></div>
                        </tr>
                      </div>
                    </div>
                  </form>
...
<!--                   <h4>INFORMATIONS LIEES A LA FACTURE</h4> 
 -->                  <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-2">
                        <label>Pieces/boites</label>
                        <select name="type_produit" onchange="get_data()" id="type_produit" class="form-control">

                         <option value="">Choisir</option>
                         <option value="2">Boites</option>
                  ...
                  <div class="col-lg-10" style="padding-top:5px;">
                    ...
                    <br>
                    <br>
                    <div id="show_btn" class="col-md-10" style="display: none;float: right;">
    ...
    <div class="modal-content">
      <form id="frmcost" method="POST">
        ...
        <div class="modal-body">
          <h3 class="text-primary">Voulez-vous vraiment valider?</h3>
          <br>
          ...
          <div class="modal-footer">
            <button type="button" id="idsave" onclick="save_info()" class="btn btn-primary" style="">Enregistrer</button>
...
<script>
  ...
  { 
    let statut=1;
    var POTENTIEL= $('#IS_POTENTIEL').val();
    var PRIS_PAR= $('#PRIS_PAR').val();
    var PRIS_PAR_tel= $('#PRIS_PAR_tel').val();
    if ($("#PRIS_PAR").val() == "") {
      statut = 2;
      $("#ErrorData").html("You must fill the receiver's info");
    } else {
      $("#ErrorData").html("");
    }
    if ($("#PRIS_PAR_tel").val() == "") {
 ...
 <script type="text/javascript">
  function get_data_client(){
    ...
    $.ajax(
    {
      url:"<?=base_url()?>index.php/exit/Magasin_sales/get_data_client/"+GROS_CLIENT_ID,
      type:"GET",
      dataType:"JSON",
      success: function(data)
      {
   ...
   function get_serv_price()
  {
    ...
    $.ajax(
    {                            
      url:"<?=base_url()?>index.php/exit/Magasin_sales/get_serv_price/"+DESIGNATION,
      type:"GET",
      dataType:"JSON",
      success: function(data)
      {
        $('#QUANTITEUN').val('');
        $('#PRIX_UNITAIRE').val(data.SERVICE_COST);
      }
    });
  }
  function get_data()
  {
    ...
    $.ajax(
    {                            
      url:"<?=base_url()?>index.php/exit/Magasin_sales/get_data/"+DESIGNATION+'/'+type_produit,
      type:"GET",
      dataType:"JSON",
      success: function(data)
      {
      ...
      if (QUANTITE1 < QUANTITEUN1 || QUANTITEUN1==0) {
        ...
        if (QUANTITEUN != "" &&  DESIGNATION != "" && PRIX_UNITAIRE != "") {
          ...
          if (!$('#DESIGNATION').val()) {
            ...
            $('#type_produit').css('border-color', 'red');
  ...
  function save_info() {
    ...
    if (statut == 1) {
      ...
      $.post("<?= base_url('index.php/exit/Magasin_sales/save_sale_manager/') ?>", {
        ...
        window.location.href = '<?= base_url('index.php/exit/Magasin_sales') ?>';
      });
    }
  }
</script>