    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6 row">
          <h5 class="m-0">&nbsp;&nbsp;&nbsp;&nbsp;Today’s sales</h5>
          <h5 class="m-0 text-success">&nbsp;&nbsp;the &nbsp<?=date('d-m-Y')?></h5>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body" style="overflow-x: auto;">
              ...
              <div class="col-md-3" style="float:right;"><input desabled class="form-control alert-primary text-white" style="font-size: 18px;" value=" Total Sales:  <?=number_format($tot['PT'], 2, ',', ' ')?>"></div>
              <br>
              <BR>
