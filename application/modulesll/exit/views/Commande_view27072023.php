                  ...
                  <fieldset class="border p-2">
                    <div class="row">
                      ...
                      <div class="col-md-2">
                        ...
                        <input type="text" name="ADRESS" id="ADRESS" readonly class="form-control" value="<?= $customer['ADRESS_GROS_CLIENT'] ?>">
                      </div>
                      <div class="col-md-2">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" readonly value="NDAYISENGA Advaxe">
                      </div>
                    </div>
                  </fieldset>
                </div>
                ...
                <form method="post">
                  <div class="row">
                    ...
                    <div class="col-md-2" style="padding:30px">
                      <a id="cartinfo" onclick="info_cart();" class=" btn btn-primary"><span class="nav-icon fas fa-plus" aria-hidden="true"></span> Check</a>
                    </div>
                  </div>
                </form>
                <!-- end -->
                          ...
                          <tbody>
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                  <a class="text-danger" href="#" onclick="remove_data(<?= $service['ID_SERV_COMMANDE'] ?>)">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <span id="DATE_LIVRAISON_error"></span>
              </div>
  ...
  function info_cart() {
    ...
    if (QUANTITY != "" && ID_SERV_COMMANDE != "" && UNIT_PRICE != "") {
      $.ajax({
        type: "POST",
        data: {
          ID_SERV_COMMANDE: ID_SERV_COMMANDE,
          QUANTITY: QUANTITY,
...
// var statut = true;
// // $("#colab_etr_error").html("Required field");
// if ($("#DATE_LIVRAISON").val()=="") {
//        $("#DATE_LIVRAISON_error").html("<font color='red'>Required field</font>");
//        return false;
//      }else{
//        $("#DATE_LIVRAISON_error").html("");
//      }

//     //  var colab=$('#colab')[0].checked;
//     //  alert(colab);
//     //  var colab_etr=$("#colab_etr")[0].checked;
//     //  alert(colab_etr);
...
// // alert();
//      if ($("#ADVANCE").val()=="") {
//        $("#ADVANCE_error").html("<font color='red'>Required field</font>");
//        return false;
...
//      if ($("#MOYEN_PAIE").val()=="") {
//        $("#MOYEN_PAIE_error").html("<font color='red'>Required field</font>");
...
<script>
  function remove_data(ID) {
    ...
    let url = "<?= base_url('index.php/exit/Magasin_sales/delete') ?>"
    // alert(url);
    $.post(url, {
      ID: ID
    }, function(data) {
      ...
      // window.location.reload('<?= base_url('exit/Magasin_sales/commande/1111') ?>');
      window.location.reload('');
