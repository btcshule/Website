...
class S_money extends CI_Controller
{
  ...
  function index()
  {
    ...
    <li class="breadcrumb-item"><a href="#">Electronique</a></li>
    <li class="breadcrumb-item active" aria-current="page">E-bank</li>
    </ol>
    </nav>';
  ...
  function liste()
  {
    ...
    $query_principal=" SELECT `ID_E_BANK`, `LIBELLE`, `MONTANT`,ELECTRONIQUE, `COMMISSION`, `SOLDE`, `TYPE_AGENT`, `DATE_ENTREE`, s_bank.STATUT, `DATE_ACTION`, NOM_EMP,PRENOM_EMP,TELEPHONE FROM `s_bank` JOIN employes ON employes.EMPLOYE_ID=s_bank.RESP_ELECT WHERE 1";
