...
<script>
	...
	$(document).ready(function() {
		...
		table=$("#mytable").DataTable({
			...
			"order":[],
			"ajax":{
				url:"<?php echo base_url('index.php/suivi/Banque/liste')?>",
				type:"POST"
			},
	...
	function enr()
	{
		...
		if (statut==true) {
			...
			if (ID_LIVRE_CAISSE=="") 
			{
				...
				url="<?php echo base_url('index.php/suivi/Banque/ajouter')?>";
			}
			else
			{
				url="<?php echo base_url('index.php/suivi/Banque/update')?>";
			}
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="mb-3">
													...
													<input type="text" autocomplete="off" name="IMPUTATION" class="form-control" id="IMPUTATION">
