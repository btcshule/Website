...
echo json_encode(array('status' => true));
  ...
  function liste()
  {
    ...
    $query_principal="SELECT `ID_LIVRE_CAISSE`, `LIBELLE`, `IMPUTATION`, NOM_EMP, PRENOM_EMP, `DEBIT`, `CREDIT`, SOLDE, `DATE_ENTREE`, `DATE_ACTION`,data_livre_caisse.STATUT FROM `data_livre_caisse` JOIN employes ON employes.EMPLOYE_ID=data_livre_caisse.RESP_CAISSE WHERE EST_ENTREE=1";
