...
class Banque extends CI_Controller
{
  ...
  function liste()
  {
    ...
    $query_principal="SELECT `ID_LIVRE_BANQUE`, `LIBELLE`,`IMPUTATION`,NOM_EMP,PRENOM_EMP, `DEBIT`, `CREDIT`, `DATE_ENTREE`, `EST_ENTREE`, data_livre_banque.STATUT, `DATE_ACTION`, `RESP_CAISSE` FROM `data_livre_banque` JOIN employes ON employes.EMPLOYE_ID=data_livre_banque.RESP_CAISSE WHERE EST_ENTREE=1";
