...
class Histo_livre_caisse extends CI_Controller
{
  ...
  function liste()
  {
    ...
    $query_principal="SELECT `ID_LIVRE_CAISSE`, `LIBELLE`, `IMPUTATION`, `DEBIT`, `CREDIT`, `SOLDE`, `DATE_ENTREE`, `EST_ENTREE`, data_livre_caisse.STATUT, `DATE_ACTION`, employes.NOM_EMP, employes.PRENOM_EMP FROM `data_livre_caisse` LEFT JOIN employes ON employes.EMPLOYE_ID=data_livre_caisse.RESP_CAISSE WHERE 1";
