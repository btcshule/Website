...
class Histo_livre_banque extends CI_Controller
{
  ...
  function liste()
  {
    ...
    $query_principal="SELECT `ID_LIVRE_BANQUE`, `LIBELLE`, `IMPUTATION`, NOM_EMP, PRENOM_EMP, `DEBIT`, `CREDIT`,SOLDE, `DATE_ENTREE`, `DATE_ACTION`,data_livre_banque.STATUT FROM `data_livre_banque` JOIN employes ON employes.EMPLOYE_ID=data_livre_banque.RESP_CAISSE WHERE 1";
