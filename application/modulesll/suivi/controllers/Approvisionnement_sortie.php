...
class Approvisionnement_sortie extends CI_Controller
{
  ...
  function liste()
  {
    $var_search = !empty($_POST['search']['value']) ? $_POST['search']['value'] : null;
     ...
     $query_principal="SELECT `ID_LIVRE_APPRO`, `LIBELLE`,`IMPUTATION`,NOM_EMP,PRENOM_EMP, `CREDIT`, `DATE_ENTREE`, `EST_ENTREE`, data_livre_approvisionnement.STATUT, `DATE_ACTION`, `RESP_CAISSE` FROM `data_livre_approvisionnement` JOIN employes ON employes.EMPLOYE_ID=data_livre_approvisionnement.RESP_CAISSE WHERE EST_ENTREE=0";
