          ...
          <div class="row">
            ...
            <div class="col-lg-12" style=" margin-bottom: 5px;">
              ...
              <div class="row" id="conta" style="margin-top: -10px">
                <div class="col-lg-6 col-md-6">
                  ...
                  <h4 class=""><b>Adding new material</b></h4> 
                </div>
                <div class="col-lg-6 col-md-6" style="padding-bottom: 3px">
                  <ul class="nav nav-pills pull-right">
                    <li ><a style="border:#0843ca solid;color:#0843ca " href="<?php echo base_url() ?>index.php/suivi/Lumicash/listing"><i class="fa fa-list"></i> All incomes</a></li>
                  </ul>
                </div>
              </div>  
            </div>
            <div class="col-lg-12 jumbotron" style="padding: 5px">
              <div class="basic-form" >
                <form method="post" action="<?=base_url()?>index.php/suivi/Materiels/ajouter">
                  <div class="form-row">
