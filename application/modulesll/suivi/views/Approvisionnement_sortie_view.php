...
<script>
	...
	$(document).ready(function() {
		...
		table=$("#mytable").DataTable({
			...
			"order":[],
			"ajax":{
				url:"<?php echo base_url('index.php/suivi/Approvisionnement_sortie/liste')?>",
				type:"POST"
			},
	...
	function enr()
	{
		...
		if (statut==true) {
			...
			if (ID_LIVRE_CAISSE=="") 
			{
				...
				url="<?php echo base_url('index.php/suivi/Approvisionnement_sortie/ajouter')?>";
			}
			else
			{
				url="<?php echo base_url('index.php/suivi/Approvisionnement_sortie/update')?>";
			}
