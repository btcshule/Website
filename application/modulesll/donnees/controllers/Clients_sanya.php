...
class Clients_sanya extends CI_Controller
{
	...
	function liste()
	{
		...
		$search = !empty($_POST['search']['value']) ? (" AND  (RS LIKE '%$var_search%' OR PRENOM_GROS_CLIENT LIKE '%$var_search%',OR NOM_GROS_CLIENT LIKE '%$var_search%' OR NIF LIKE '%$var_search%' OR RC LIKE '%$var_search%' OR RS LIKE '%$var_search%' OR ADRESS_GROS_CLIENT LIKE '%$var_search%'OR STATUT LIKE '%$var_search%') ") : '';
