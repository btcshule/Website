...
class Fournisseurs extends CI_Controller
{
	...
	function liste()
	{
		...
		$search = !empty($_POST['search']['value']) ? (" AND  (RS LIKE '%$var_search%' OR PRENOM_FOURNISSEUR LIKE '%$var_search%',OR TEL_FOURNISSEUR LIKE '%$var_search%' OR NIF LIKE '%$var_search%' OR RC LIKE '%$var_search%' OR RS LIKE '%$var_search%' OR NOM_FOURNISSEUR LIKE '%$var_search%'OR STATUT LIKE '%$var_search%') ") : '';
