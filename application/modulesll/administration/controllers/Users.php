...
*/
 ...
 class Users extends CI_Controller
 {
 	...
 	{
 		$this->_validate();
 		$DESC_MINISTERE=$this->input->post('DESC_MINISTERE');

 		$data=array('DESC_MINISTERE'=>trim($DESC_MINISTERE));
 	...
 	function liste()
 	{
 		...
 		$query_principal="SELECT `EMPLOYE_ID`, `NOM_EMP`, `PRENOM_EMP`, `EMAIL_EMP`, `MINISTERE_ID`, `OU_ID`, `IS_USER_SYSTEM`, `MATRICULE`, `MOT_DE_PASSE`, `USER_ID`, `DATE_CREATION`, `IS_ACTIF`,DESC_PROFIL, `IS_MUST_CHANGE_PWD`, `TOKEN` FROM `employes` JOIN profil ON profil.PROFILE_ID=employes.PROFILE_ID WHERE 1";

 		$order_column=array("NOM_EMP","","");
